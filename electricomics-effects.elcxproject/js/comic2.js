...
/* ************
Lightly modified version of core script, changed to allow easy addition of custom transforms.
...
*/
//declare stepactions and nav as global variable, so we can add to it in subsequent scripts
var stepActions = {};
var globalNav={};
...
var CreateDigitalComic = function(options) {
  ...
  globalNav.getCurrentEl=getCurrentEl;
  globalNav.getNextEl=getNextEl;
  globalNav.getPrevEl=getPrevEl;
